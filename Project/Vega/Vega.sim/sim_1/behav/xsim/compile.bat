...
REM
REM Generated by Vivado on Thu Apr 23 15:40:34 +0800 2026
...
echo "xvlog --incr --relax -prj vega_soc_top_vlog.prj"
call xvlog  --incr --relax -prj vega_soc_top_vlog.prj -log xvlog.log
