...
HD_PWD='C:/Users/Windink/Desktop/Vega_cpu/Project/Vega/Vega.runs/boot_rom_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boot_rom_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source boot_rom_ip.tcl
