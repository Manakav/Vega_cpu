...
#
# Script generated by Vivado on Mon Apr 13 18:12:28 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : boot_rom_ip.sh
...
#
# Usage        : boot_rom_ip.sh
#                boot_rom_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                boot_rom_ip.sh [-rerun]
#                boot_rom_ip.sh [-reset_run]
#                boot_rom_ip.sh [-clean]
#                boot_rom_ip.sh [-reset_log]
#                boot_rom_ip.sh [-help]
#
...
export RDI_DATADIR="D:/Xilinx/2025.2/Vivado/data"
...
# script info
echo -e "boot_rom_ip.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./boot_rom_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot boot_rom_ip xil_defaultlib.boot_rom_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim boot_rom_ip -key {Behavioral:sim_1:Functional:boot_rom_ip} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xilinx/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb boot_rom_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./boot_rom_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: boot_rom_ip.sh [-help]\n\
Usage: boot_rom_ip.sh [-step]\n\
Usage: boot_rom_ip.sh [-lib_map_path]\n\
Usage: boot_rom_ip.sh [-rerun]\n\
Usage: boot_rom_ip.sh [-reset_run]\n\
Usage: boot_rom_ip.sh [-clean]\n\
Usage: boot_rom_ip.sh [-reset_log]\n\
Usage: boot_rom_ip.sh [-keep_index]\n\
Usage: boot_rom_ip.sh [-noclean_files]\n\n\
