...
#
# Script generated by Vivado on Mon Apr 13 22:17:02 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : data_ram_b.sh
...
#
# Usage        : data_ram_b.sh
#                data_ram_b.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                data_ram_b.sh [-rerun]
#                data_ram_b.sh [-reset_run]
#                data_ram_b.sh [-clean]
#                data_ram_b.sh [-reset_log]
#                data_ram_b.sh [-help]
#
...
# script info
echo -e "data_ram_b.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./data_ram_b.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_ram_b xil_defaultlib.data_ram_b xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim data_ram_b -key {Behavioral:sim_1:Functional:data_ram_b} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb data_ram_b.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./data_ram_b.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: data_ram_b.sh [-help]\n\
Usage: data_ram_b.sh [-step]\n\
Usage: data_ram_b.sh [-lib_map_path]\n\
Usage: data_ram_b.sh [-rerun]\n\
Usage: data_ram_b.sh [-reset_run]\n\
Usage: data_ram_b.sh [-clean]\n\
Usage: data_ram_b.sh [-reset_log]\n\
Usage: data_ram_b.sh [-keep_index]\n\
Usage: data_ram_b.sh [-noclean_files]\n\n\
